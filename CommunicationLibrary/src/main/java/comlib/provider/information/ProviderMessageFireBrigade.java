...
public class ProviderMessageFireBrigade extends HumanMessageProvider<MessageFireBrigade, EventMessageFireBrigade>
{
	public ProviderMessageFireBrigade(int id)
	{
		super(id);
	}
