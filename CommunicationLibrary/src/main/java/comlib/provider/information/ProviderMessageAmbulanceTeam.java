...
import comlib.event.information.EventMessageAmbulanceTeam;
...
public class ProviderMessageAmbulanceTeam extends HumanMessageProvider<MessageAmbulanceTeam, EventMessageAmbulanceTeam>
{
	public ProviderMessageAmbulanceTeam(int id)
	{
		super(id);
	}
